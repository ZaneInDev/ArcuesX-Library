function AddWindow(title)
    ...
    ComboElem = Instance.new("ImageButton")
    ...
    ComboBox = Instance.new("ImageButton")
    UICorner_8 = Instance.new("UICorner")
    Name_4 = Instance.new("TextLabel")
    UIGradient_4 = Instance.new("UIGradient")
    Img_2 = Instance.new("TextLabel")
    UIAspectRatioConstraint_5 = Instance.new("UIAspectRatioConstraint")
    
    local AbsoluteTitle = `Arceus X <font color="rgb(255, 0, 0)">|</font> title`
    ...
    local function AddComboBox(text, options, funct, teamCheck, ...)
        ...
        for _, name in ipairs(options) do
            ...
            newElem.MouseButton1Click:Connect(function()
                ...
                if teamCheck then
                    funct(name == "Team Check" and "Team Check" or "BillboardGui Check", unpack(args))
                else
